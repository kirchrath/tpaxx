Ext.define('tpaxx.packages.core.store.Country', {
    extend: 'Ext.data.Store',

    storeId: 'country',

    alias: 'store.tpaxx-packages-core-country',

    model: 'tpaxx.packages.core.model.Country',
    ...
    data: {
        countries: [
            ...
            {code: 'CA', name: 'Canada'},
            {code: 'CV', name: 'Cape Verde Islands'},
            ...
            {code: 'KN', name: 'Saint Christopher & Nevis'},
            ...
            {code: 'GS', name: 'South Georgia & The South Sandwish Islands'},
